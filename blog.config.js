...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个产品设计狮🦁，Hi，我是一个前端程序猿🐵，我是VPainter，欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'VPainter', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '原创产品概念设计狮🦁', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vpainter.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '知识分享,交流博客,产品设计案例,设计师干货笔记,日常生活实用小技巧', // 网站关键词 英文逗号隔开
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.vpainter.store', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
